...
def reformat(stock_csv):
    #load scraped stock_sheet and two reference sheets called multiplier_sheet and location_sheet
    #stock_csv= './stock_sheet.csv'
    multiplier_csv= './reference_sheets/multiplier_sheet.csv'
    location_csv = './reference_sheets/location_sheet.csv'
    ...
    item_location_df.to_csv("./output_stock_sheets/%s_reformated_output.csv" %date)
